    ...
    <div className="h-full flex flex-col bg-surface relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 max-w-[400px] mx-auto w-full relative z-10">
        ...
        <div className="animate-slide-up text-center">
          {/* Icon */}
          <div className="w-16 h-16 bg-gray-900 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-black/10">
            <Heart className="w-8 h-8 text-white" fill="white" strokeWidth={0} />
          </div>

          <h1 className="text-[38px] font-bold text-gray-900 tracking-tight leading-none">
            SBUdate
          </h1>
        ...
        {/* Trust badges */}
        <div className="flex items-center gap-4 mt-8 animate-fade-in" style={{ animationDelay: "200ms" }}>
          <span className="text-[12px] text-gray-400">SBU students only</span>
          <span className="text-gray-300">·</span>
          <span className="text-[12px] text-gray-400">Free to use</span>
          <span className="text-gray-300">·</span>
          <span className="text-[12px] text-gray-400">Private</span>
        </div>
      </div>

      {/* Footer */}
      <div className="px-8 pb-10 text-center relative z-10 animate-fade-in" style={{ animationDelay: "250ms" }}>
